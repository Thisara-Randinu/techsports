    ...
    () =>
      theme.palette.mode === "dark"
        ? [
            ...
            "rgba(204, 194, 220, 0.15)",
            "rgba(154, 130, 219, 0.12)",
            "rgba(184, 169, 204, 0.12)",
            "rgba(103, 80, 164, 0.18)",
            "rgba(98, 91, 113, 0.15)",
          ]
        : [
            "rgba(103, 80, 164, 0.12)",
            "rgba(98, 91, 113, 0.12)",
            "rgba(154, 130, 219, 0.1)",
            "rgba(147, 143, 153, 0.1)",
            "rgba(79, 55, 139, 0.15)",
            "rgba(74, 68, 88, 0.12)",
          ],
    [theme.palette.mode],
...
function AnimatedShape({ shape }: { shape: Shape }) {
